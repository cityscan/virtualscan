$('document').ready( function() {
 ...
 function createSelector(layer) {
  ...
  $options.click(function(e) {
    ...
    map = L.map('map', {
       center: new L.latLng(41.8797856, -88.0116832),
       zoom: 12,
       minZoom: 9,
      });
          ...
          interactivity: "id,type,height,lat,lon,imageurl,thumbnail_url,comments,cartodb_id,head_type,material,num_devices,num_fuses,num_other_devices,num_spreaders,num_switchgear,num_transformers,owner_id,spreader_length,tilt,width,simple_id"
            ...
            .done(function(layer) {
              ...
              createSelector(subLayer);
                      ...
                      $('#sidebar').append('<a href="https://s3.amazonaws.com/cityscan-demo-img/lombard_img/cityscan_3024.jpg " target="_blank"><img src="https://s3.amazonaws.com/cityscan-demo-img/lombard_img/cityscan_3024.jpg" height="250" width="300" id="image_sidepanel"></a>');
