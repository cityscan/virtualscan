...
// old:
// http://cityscan.cartodb.com/api/v2/viz/5bf5c460-69a4-11e3-8a42-35e8427dfec0/viz.json;
// new
//'http://cityscan.cartodb.com/api/v2/viz/5482c74a-771a-11e3-86e7-7310244efac4/viz.json';
    ...
    */
    ...
    var LayerActions = {
        ...
        awning: function() {
            sublayers[0].setSQL("SELECT * FROM nyc WHERE type = 'Awning'")
            return true;
        },
        billboard: function() {
            sublayers[0].setSQL("SELECT * FROM nyc WHERE type = 'Billboard'")
            return true;
        },
        dumpster: function() {
            sublayers[0].setSQL("SELECT * FROM nyc WHERE type = 'Dumpster'")
            return true;
        },
        fence: function() {
            sublayers[0].setSQL("SELECT * FROM nyc WHERE type = 'Fence'")
            return true;
        },
        scaffold: function() {
            sublayers[0].setSQL("SELECT * FROM nyc WHERE type = 'Scaffolding'")
            return true;
        },
        sidewalkshed: function() {
            sublayers[0].setSQL("SELECT * FROM nyc WHERE type = 'Sidewalk Shed'")
            return true;
        }
    }
